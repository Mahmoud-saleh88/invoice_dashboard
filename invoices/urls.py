...
urlpatterns = [
    ...
    path('sales/<int:pk>/zatca/test/', views.zatca_compliance_test, name='test_xml'),
    path('sales/<int:pk>/zatca/xml/', views.zatca_view_xml, name='view_xml'),
    path('sales/<int:pk>/zatca/export-xml/', views.export_invoice_xml, name='export_invoice_xml'),
    path('sales/<int:pk>/zatca/qr/', views.test_qr_generation, name='test_qr'),
    ...
    path('purchases/<int:pk>/', views.purchases_detail, name='purchases_detail'),
    path('purchases/<int:pk>/delete/', views.purchases_delete, name='purchases_delete'),

    # Clients
    path('clients/', views.client_list, name='client_list'),
    path('clients/add/', views.client_create, name='client_create'),
    path('clients/<int:pk>/', views.client_statement, name='client_statement'),
    ...
    path('journal/edit/<int:pk>/', views.journal_entry_edit, name='journal_entry_edit'),
    path('journal/export/', views.journal_export_excel, name='journal_export_excel'),
